...
export default {
  ...
  watch: {
    page() {
      /* Utilizando o watch para monitorar o atributo page. Assim que ele alterar, o watch chama o getArticles
  que retorna os artigos fazendo a paginação conforme a variável vai mudando */
      this.getArticles();
    },
  },
  methods: {
    getArticles() {
      ...
      axios
        ...
        .then((res) => {
          ...
          /* data é o nome do atributo onde setamos o artigo, limit e count no backend */
